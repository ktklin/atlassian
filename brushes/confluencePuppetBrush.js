 ...
 *
 * @license
 * The confluencePuppetBrush.js extension for Confluence is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * confluencePuppetBrush.js is distributed in the hope that it will be useful,
 ...
 */
SyntaxHighlighter.brushes.Puppet = function()
{
  var colorCodes = new Object();
  colorCodes['keywords']  = 'keyword';
  colorCodes['resources'] = 'resources keyword';
  colorCodes['variables'] = 'variables functions keyword';
  colorCodes['functions'] = 'functions';
  colorCodes['brackets']  = 'op';
  colorCodes['operator']  = 'op';
  ...
  var builtins  = 'action augeas burst chain computer cron destination dport exec ' +
  ...
  var funcs    = 'alert assert_type binary_file break contain create_resources crit debug defined dig digest each' +
                 'emerg epp err fail filter find_file fqdn_rand generate hiera hiera_array hiera_hash hiera_include' +
  ...
  this.regexList = [
    ...
    { regex: new RegExp(this.getKeywords(builtins), 'gm'),  css: colorCodes['keywords'] }
  ];
};

SyntaxHighlighter.brushes.Puppet.prototype  = new SyntaxHighlighter.Highlighter();
SyntaxHighlighter.brushes.Puppet.aliases    = ['puppet'];
